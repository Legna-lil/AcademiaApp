...
fun PaperList(
    ...
    LaunchedEffect(isLoading, isRefreshing, hasInitialDataLoaded) {
        Log.i("Paper List", "isLoading $isLoading, isRefreshing $isRefreshing, isUpdating $hasInitialDataLoaded")
    }

    val showFullScreenLoading = (isLoading && !hasInitialDataLoaded.value) || isRefreshing

    LaunchedEffect(Unit) {
        if (papers.isNotEmpty() && !isLoading) {
